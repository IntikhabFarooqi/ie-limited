        ...
        <div className="flex gap-x-6 lg:flex-row max-lg:flex-col relative">
          ...
          <div className="flex-1 flex flex-col w-full">
            ...
            <div className="max-w-7xl flex flex-col md:flex-row items-center md:items-stretch gap-4 px-6 py-6">
              ...
              <div className="flex space-x-4 px-6 py-4 text-center md:text-left">
                <span className="text-5xl font-bold text-cyan-400">3000+</span>
          ...
          <div className="flex-1 flex flex-col items-start mt-12 sm:mb-6 md:mb-3 max-sm:mb-3 md:mt-0">
            ...
            <div className="bg-gradient-to-b from-[#86D8EB] to-[#ffffff] border-l-4 border-[#86D8EB] rounded-xl p-6 mb-6 w-full">
              ...
              Glonect is a leading provider of broadcast and media technology solutions. We specialize in delivering comprehensive services, including system integration, automation, AV solutions, and technical support.
              </p>
            </div>
            <p className="text-base text-gray-700 max-sm:text-sm mb-4 text-md">&#x2022; Empowering Growth with Smart Solutions </p>
            <p className="text-base text-gray-700 max-sm:text-sm mb-4 text-md">&#x2022; Collaborative Approach for Maximum Impact </p>
            <p className="text-base text-gray-700 max-sm:text-sm mb-4 text-md">&#x2022; Innovative Solutions, Real-World Results </p>
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 text-lg md:text-xl mb-2">
            ...
            Glonect. was born out of a simple idea: to bridge the gap
            ...
            <div className="flex flex-col max-sm:gap-4 md:divide-y-1 divide-gray-300 max-md:divide-x-1 items-center max-md:flex-row md:items-end">
              ...
              <div className="bg-white p-5 max-w-xs w-full">
                ...
                <p className="text-sm text-gray-600">
                  No cookie-cutter jargon. Every project is built uniquely for
                  your needs.
                </p>
              </div>
              {/* Bottom Left Feature */}
              <div className="bg-white p-5 max-w-xs w-full mt-auto">
                ...
                <p className="text-sm text-gray-600">
                From building to maintaining, we optimize for real-world success.
                </p>
              </div>
            </div>
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="ml-2 text-gray-700 text-base">
              Join and share your experiences, Ideas with Glonect. We are here
