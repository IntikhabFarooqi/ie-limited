          ...
          <div className="flex-1 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="text-md md:text-sm text-gray-900 leading-relaxed">
                ...
                Post production is a creative process that cannot be automated but can be streamlined by software assistance. Various production steps such as color correction, animations, graphics, editing and audio mixing are performed. Flow PMS keeps all essences, that are part of a production, under control.
