          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <h2 className="text-5xl md:text-3xl lg:text-5xl text-[#283a64]">
                Empowering Business With <span className="text-cyan-400">Technology</span>
              </h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              We help businesses leverage cutting-edge to drive growth, streamline operations, and enhance tailored solutions are designed to solve complex issues.
              </p>
