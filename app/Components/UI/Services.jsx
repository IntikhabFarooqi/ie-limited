  ...
  const services = [
    {
      ...
      description: "Integrating your systems to work together seamlessly.",
      link: "/custom-web-development-services",
    },
    {
      icon: <FaMobile className="w-8 h-8 text-cyan-400" />,
      title: "Technology Solutions",
      description: "Offering tailored technology solutions that last long.",
    ...
    },
    {
      ...
      description:
        "Enhancing your online classes through strategic integrations.",
    ...
    <section className={`${font.className} py-16 bg-white relative z-20`}>
      <div className="max-w-7xl mx-auto px-6 max-sm:w-full">
        ...
        <p className="bg-gradient-to-b from-[#86D8EB] to-[#ffffff] rounded-xl p-6 text-gray-900 mb-4 text-base md:text-md">
          ...
          Integration, Technology, and Educational solutions all
          provided in one place. At Glonect, our mission goes
          beyond simply creating technology solutions; we aim to create success
          stories.
        </p>
