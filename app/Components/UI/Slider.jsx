...
const Slider = () => {
  const technologies = [
    { name: "Broadcasting", icon: FaReact },
    { name: "Live Streaming", icon: RiNextjsFill },
    { name: "Education", icon: FaTiktok },
    { name: "Broadcasting", icon: FaTiktok },
    { name: "Live Streaming", icon: FaTiktok },
    { name: "Education", icon: FaTiktok },
    { name: "Broadcasting", icon: FaTiktok },
    { name: "Live Streaming", icon: FaTiktok },
    { name: "Education", icon: FaTiktok },
