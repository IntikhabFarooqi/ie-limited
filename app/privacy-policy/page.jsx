        ...
        <div className="w-full max-w-7xl mx-auto flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <div className="text-md md:text-sm text-gray-900 leading-relaxed">
              <p className="mb-4">
                At <span className="text-cyan-400"> Glonect</span>,
            ...
            <section>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="text-sm pl-8 mb-3 list-disc">
                    <li>Glonect does not rent or sell your personally identifiable information to third parties.</li>
                    ...
                    <li>Our blog or comment sections may be managed by third-party platforms. Glonect does not control how they collect or use your data. Please refer to their privacy policies.</li>
                ...
                <div>
                  ...
                  <p className="text-sm md:text-md mb-3">
                    Glonect may update this Privacy Policy from time to time. Any changes will be posted on this page with a revised "Effective Date." We encourage you to review this policy periodically to stay informed about how we protect your information.
                  </p>
                </div>
              </div>
            </section>
