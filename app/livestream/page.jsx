          ...
          <div className="flex-1 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="text-md md:text-sm text-gray-900 leading-relaxed">
                ...
                MPEG-TS, and HLS, which allows you to broadcast directly to your personal website, your Facebook page, or any content delivery network (CDN); e.g. Akamai, Livestream.com, or UStream.tv. You can also choose from three capable streaming interfaces including dual band 802.11a/b/g/n MIMO WiFi, Ethernet, or a 3G/4G USB modem. This versatility ensures that you are never stuck without connectivity wherever you need to go live.
                  <br />
                  <br />
                <br />
                  <br />
